...
def main():
    ...
    print(data_mining(get_closest_tuesday(date.today()), response, s))
    print(data_mining(get_closest_tuesday(date.today() + timedelta(days=7)), response, s))
    print(data_mining(get_closest_tuesday(date.today() + timedelta(days=14)), response, s))
    print(data_mining(get_closest_tuesday(date.today() + timedelta(days=21)), response, s))
...
def data_mining(date_list, response, s=None):
    ...
    return '>>>>> END OF DATA MINING ROUND <<<<<'
